    ...
    <div className="flex-1 overflow-hidden flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto flex items-center justify-center p-8">
        <div className="max-w-lg text-center flex flex-col items-center">
          ...
          {/* Heading */}
          <h2 className="text-xl font-sans font-bold text-ink mb-4">You're All Set!</h2>
          ...
          <div className="flex items-center justify-center space-x-4 mb-6">
            {TOOL_ICONS.map((tool) => (
              <div
                key={tool.name}
                className="relative w-10 h-10 bg-success/15 text-success flex items-center justify-center"
                title={tool.name}
              >
                {tool.icon}
          ...
          {/* Summary */}
          <p className="text-ink-secondary mb-10 leading-relaxed whitespace-nowrap">
